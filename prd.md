...
*   **Kiracı İçin (1-to-1 İlişki):** Emlakçı, kiracı profilini ilgili tek bir daireyle eşleştirerek kaydeder. Sistem, şifrelenmiş davet linkini içeren şu şablonda bir mesaj üretir: *"Emlakdefteri sistemine kaydınız açılmıştır. Kira takibinizi yapmak için tıklayın: [Link]"*
